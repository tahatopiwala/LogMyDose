...
export default function SubstanceForm() {
  ...
  useEffect(() => {
    if (substanceData?.substance) {
      ...
      setFormData({
        ...
        shelfLifeReconstitutedDays:
          s.shelfLifeReconstitutedDays?.toString() || "",
  ...
  const updateMutation = useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof substancesApi.updateSubstance>[1];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const data = {
      ...
      defaultDose: formData.defaultDose
        ? parseFloat(formData.defaultDose)
        : undefined,
      ...
      shelfLifeDays: formData.shelfLifeDays
        ? parseInt(formData.shelfLifeDays)
        : undefined,
      shelfLifeReconstitutedDays: formData.shelfLifeReconstitutedDays
        ? parseInt(formData.shelfLifeReconstitutedDays)
        : undefined,
      requiresCycling: formData.requiresCycling,
      commonCycleOnWeeks: formData.commonCycleOnWeeks
        ? parseInt(formData.commonCycleOnWeeks)
        : undefined,
      commonCycleOffWeeks: formData.commonCycleOffWeeks
        ? parseInt(formData.commonCycleOffWeeks)
        : undefined,
    ...
    if (isEdit) {
      ...
      createMutation.mutate(
        data as Omit<Substance, "id" | "isActive" | "createdAt" | "category">,
      );
    }
  };
            ...
            <div>
              ...
              <div className="mt-1 flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, aliasInput: e.target.value })
                  }
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(), addToArray("aliases", "aliasInput"))
                  }
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.aliases.map((alias) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => removeFromArray("aliases", alias)}
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, defaultDose: e.target.value })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
              />
            </div>
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, doseUnit: e.target.value })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, defaultFrequency: e.target.value })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
              >
        ...
        <div className="bg-white shadow rounded-lg p-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    shelfLifeReconstitutedDays: e.target.value,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
              />
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, storageNotes: e.target.value })
              }
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
            />
          </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="flex items-center mb-4">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, requiresCycling: e.target.checked })
              }
              className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
            />
            <label
              htmlFor="requiresCycling"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      commonCycleOnWeeks: e.target.value,
                    })
                  }
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      commonCycleOffWeeks: e.target.value,
                    })
                  }
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
              ...
              <div className="mt-1 flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      contraindicationInput: e.target.value,
                    })
                  }
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(),
                    addToArray("contraindications", "contraindicationInput"))
                  }
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
                <button
              ...
              <div className="mt-1 flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      sideEffectInput: e.target.value,
                    })
                  }
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(),
                    addToArray("commonSideEffects", "sideEffectInput"))
                  }
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
                <button
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.commonSideEffects.map((item) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => removeFromArray("commonSideEffects", item)}
              ...
              <div className="mt-1 flex gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      interactionInput: e.target.value,
                    })
                  }
                  onKeyPress={(e) =>
                    e.key === "Enter" &&
                    (e.preventDefault(),
                    addToArray("interactions", "interactionInput"))
                  }
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
                <button
                  type="button"
                  onClick={() => addToArray("interactions", "interactionInput")}
                  className="px-3 py-2 bg-gray-100 rounded-md hover:bg-gray-200"
                >
                  Add
                </button>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.interactions.map((item) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => removeFromArray("interactions", item)}
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, onsetTimeline: e.target.value })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
