...
export default function ProtocolTemplateForm() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({
      ...
      id: string;
      data: Parameters<typeof protocolsApi.updateTemplate>[1];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const data = {
      ...
      cycleOnWeeks: formData.cycleOnWeeks
        ? parseInt(formData.cycleOnWeeks)
        : undefined,
      cycleOffWeeks: formData.cycleOffWeeks
        ? parseInt(formData.cycleOffWeeks)
        : undefined,
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, substanceId: e.target.value })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
              >
