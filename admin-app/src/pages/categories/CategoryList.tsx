...
export default function CategoryList() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: Parameters<typeof substancesApi.updateCategory>[1] }) =>
    ...
    <div>
      <div className="sm:flex sm:items-center sm:justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage substance categories</p>
        </div>
        <button
          onClick={() => openModal()}
