    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">Add a Protocol</h1>
...
function TemplateCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-primary-300 hover:shadow-sm transition-all">
      <div className="flex items-start justify-between mb-3">
        ...
        {template.difficultyLevel && (
          <span
            className={`px-2 py-0.5 text-xs font-medium rounded-full ${difficultyColors[template.difficultyLevel] || "bg-gray-100 text-gray-700"}`}
          >
            {template.difficultyLevel}
          </span>
        )}
