        ...
        <div className="bg-white py-8 px-4 shadow-sm rounded-xl sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Must be at least 12 characters</p>
          ...
          <p className="mt-6 text-center text-xs text-gray-500">
            ...
            <a href="https://logmydose.com/terms" className="text-primary-600 hover:text-primary-500">
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="https://logmydose.com/privacy" className="text-primary-600 hover:text-primary-500">
              Privacy Policy
            </a>
          </p>
        </div>
