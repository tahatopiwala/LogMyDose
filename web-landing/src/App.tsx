  ...
  return (
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p className="text-gray-600">
          We collect information you provide directly, such as dose logs, health metrics,
        ...
        <p className="text-gray-600">
          Your health data is used to provide personalized insights and track your progress.
