      ...
      <div className="max-w-7xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5" staggerDelay={0.08}>
          ...
          <StaggerItem className="md:col-span-2 lg:col-span-2">
            <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-3xl p-8 lg:p-10 text-white relative overflow-hidden h-full">
              ...
              <div className="relative">
                ...
                <h3 className="mt-6 text-2xl lg:text-3xl font-bold">Simple Dose Logging</h3>
          ...
          {/* See Your Patterns */}
          <StaggerItem>
            <div className="bg-emerald-50 rounded-3xl p-6 lg:p-8 border border-emerald-100 h-full">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <h3 className="mt-5 text-xl font-semibold text-gray-900">See Your Patterns</h3>
          ...
          {/* Side Effect Notes */}
          <StaggerItem>
            <div className="bg-amber-50 rounded-3xl p-6 lg:p-8 border border-amber-100 h-full">
              <div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center text-amber-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
              </div>
              <h3 className="mt-5 text-xl font-semibold text-gray-900">Side Effect Notes</h3>
              <p className="mt-2 text-gray-600">
          ...
          {/* Progress Tracking */}
          <StaggerItem>
            <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-200 h-full">
              <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center text-primary-600">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="mt-5 text-xl font-semibold text-gray-900">Progress Tracking</h3>
              <p className="mt-2 text-gray-600">
          ...
          <StaggerItem>
            <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-200 h-full">
              ...
              <h3 className="mt-5 text-xl font-semibold text-gray-900">Export & Share</h3>
              <p className="mt-2 text-gray-600">
          ...
          <StaggerItem>
            <div className="bg-gray-900 rounded-3xl p-6 lg:p-8 text-white flex items-center gap-5 h-full">
